...
console.log(createMenuItem("Wisconsin Mac", 12, "Lunch"));
console.log(createMenuItem("Pancakes", 5, "Breakfast"));
console.log(createMenuItem("Meatloaf", 7, "Dinner"));
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(customerStatus) {
    if (customerStatus === "teacher" || "student") {
...
reviews.push({name: "Taylor", rating: 5, feedback: "Phenomenal. Fantastic. Best food ever. Greatest people. Stellar place."})
console.log(reviews);
